...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>SNAPinfo | <?php echo NOMPAGE; ?></title>
    ...
    <!-- SNAPINFO STYLE  -->
    <link href="assets/css/snapinfo.css" rel="stylesheet" />
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    &nbsp;&nbsp;
                    <strong>Contact: </strong>+221 77 777 77 77
                </div>
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h4 class="page-head-line"><?php echo NOMSTRUCTURE;?></h4>
                </div>
