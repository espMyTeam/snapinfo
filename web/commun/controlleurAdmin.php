...
*/
  ...
  if($_REQUEST["action"]=="ajouter"){
    ...
    $reqServeur->addStructure($_REQUEST["typeStruture"],$_REQUEST["libelle"],$_REQUEST["adresse"],$_REQUEST["contact1"],$_REQUEST["contact2"],$_REQUEST["mail"],$_REQUEST["latitude"],$_REQUEST["longitude"],$_REQUEST["zone"]);
